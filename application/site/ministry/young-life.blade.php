                ...
                <div class="row">
                    <div class="moto-cell col-sm-12" data-container="container">
                        ...
                        <span class="moto-widget-image-link">
                            <img data-src="{{ asset('www/content/img/ministry/young.png') }}"
                                    ...
                                    <div class="moto-widget moto-widget-row__column moto-cell col-sm-6"
                                        ...
                                        <div
                                            ...
                                            <div class="moto-widget-text-content moto-widget-text-editable">
                                                <h2 class="moto-text_system_7">Young Life</h2>
                                                <p class="moto-text_system_8 moto-spacing-top-zero moto-spacing-bottom-small">
                                                </p>
                                                <p class="moto-text_system_10">•College age
                                                    ministry is an exciting group to be apart of. This is the age when
                                                    you start setting yourself up for a lifetime of choices. Join in
                                                    fellowship with people your age.</p>
