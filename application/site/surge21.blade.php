    ...
    <div class="page">
        ...
        <section id="section-content" class="content page-13 moto-section" data-widget="section"
            ...
            <div
                ...
                style="background-color:;background-image:url('{{asset('www/content/img/surge.jpg')}}');background-position:center;background-repeat:no-repeat;background-size:cover;"
                data-bg-image="{{asset('www/content/img/surge.jpg')}}" data-bg-position="center">
                        ...
                        <div class="moto-cell col-sm-12" data-container="container">
                            ...
                            <div
                                ...
                                <div class="moto-widget-text-content moto-widget-text-editable"><h1
                                        style="text-align: center;" class="moto-text_system_5"></h1></div>
                            </div>
                                    ...
                                    <div class="row" data-container="container">
                                        <div class="moto-widget moto-widget-row__column moto-cell col-sm-12"
                                            ...
                                            <div
                                                ...
                                                data-animation="">
                                                <script id="subsplash-embed-cr7jzb5" type="text/javascript">var target = document.getElementById("subsplash-embed-cr7jzb5");var script = document.createElement("script");script.type = "text/javascript";script.onload = function() {subsplashEmbed("+3bd8/lb/li/+8n9vwx4?embed&branding&&1609262974667","https://subsplash.com/","subsplash-embed-cr7jzb5");};script.src = "https://dashboard.static.subsplash.com/production/web-client/external/embed-1.1.0.js";target.parentElement.insertBefore(script, target);</script>
                                            </div>
                                        </div>
